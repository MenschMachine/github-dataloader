...
- **3-9 unchanged runs**: Poll every 10 minutes
- **10-24 unchanged runs**: Poll every 20 minutes
- **25+ unchanged runs**: Poll every 30 minutes (max)

**Daily reset:** At 7am HKT (23:00 UTC) each day, the backoff automatically resets regardless of unchanged count. This ensures fresh data every morning.
